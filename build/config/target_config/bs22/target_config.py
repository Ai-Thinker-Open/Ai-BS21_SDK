...
target_template = {
    'target_bs22_application_template': {
        'chip': 'bs22',
        'chip_family': 'bs2x',
        'core': 'acore',
        'board': 'evb',
        ...
        'defines': ['-:CHIP_BS22=1', 'LIBCPU_UTILS', 'LIBLIB_UTILS', 'PRE_ASIC', 'LIBPANIC', 'LIBAPP_VERSION',
                    'VERSION_STANDARD', 'LIBBUILD_VERSION', "CONFIG_UART_FIFO_DEPTH=64", 'FLASH_1M',
                    'LIBTEST_COMMON', '_ALL_SOURCE', 'LOSCFG_MEM_TASK_STAT', 'SUPPORT_CXX', 'BS22_PRODUCT_EVB',
        ...
        'image_version':'bs22h',
        'gen_sec_bin': True,
        'loaderboot_cfg': 'loaderboot-bs22-n1100',
        'flashboot_cfg': 'flashboot-bs22-n1100',
    },
}
