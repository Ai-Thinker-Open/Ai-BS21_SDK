...
#define I2C_FPS_MODE_BAUDRATE_HIGH_LIMIT (1000 * 1000)  /*!< @if Eng I2C baudrate high limit in fast plus mode.
                                                              @else   快速+模式下I2C波特率最大限值 @endif */
#endif
...
typedef enum hal_i2c_speed_mode {
    ...
    I2C_SPEED_MODE_FS,                  /*!< @if Eng I2C fast speed mode.
                                             @else   I2C快速模式。 @endif */
#ifdef CONFIG_I2C_SUPPORT_FAST_PLUS_SPEED
    I2C_SPEED_MODE_FPS,                 /*!< @if Eng I2C fast plus speed mode.
                                             @else   I2C快速+模式。 @endif */
#endif
